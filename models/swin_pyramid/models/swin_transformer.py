...
class SwinTransformerPyramid(nn.Module):
    r""" Swin Transformer
...
class SwinTransformerHeatmap(nn.Module):
    r""" Swin Transformer with plain heatmap head
    ...
    def feature_to_heatmap(self, feature):
    ...
    def forward(self, x):
        ...
        pred_heatmap = self.feature_to_heatmap(feature)
        # x = self.head(x)
        return pred_heatmap
